...
## Corpus Check
- 148 files · ~1,149,939 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 948 nodes · 1597 edges · 67 communities (59 shown, 8 thin omitted)
...
1. `🔍 Analisis Komprehensif & "Roasting" UI/UX: habibiahmada.dev` - 38 edges
2. `cn()` - 34 edges
3. `fail()` - 28 edges
4. `serverError()` - 28 edges
5. `ok()` - 27 edges
6. `getSupabaseServerClient()` - 24 edges
7. `getSupabaseAdmin()` - 22 edges
8. `withAdmin()` - 21 edges
...
### Community 0 - "admin/blog/route.ts"
Cohesion: 0.08
Nodes (67): containsEmDash(), DELETE(), GET(), handleDelete(), handleGet(), handlePatch(), PATCH(), PATCH_FIELDS (+59 more)

### Community 1 - "navigation.tsx"
Cohesion: 0.27
Nodes (5): linkActive(), NAV_LINKS, Navbar(), Footer(), AnimatedThemeToggle()

### Community 2 - "case-studies.ts"
Cohesion: 0.25
Nodes (8): generateStaticParams(), bySlug, CASE_STUDIES, CaseStudy, getCaseStudySlugs(), getLinkedCaseStudies(), published, slugByProjectId
...
### Community 6 - "blog.ts"
Cohesion: 0.16
Nodes (14): BlogPage(), BlogPageProps, CATEGORY_LABELS, categoryBadgeColor(), formatDate(), metadata, generateStaticParams(), sitemap() (+6 more)
...
### Community 8 - "data/projects.ts"
Cohesion: 0.06
Nodes (40): GET(), metadata, Page(), Home(), ProjectsPageRoute(), AboutHero(), AboutTechStack(), row1 (+32 more)
...
### Community 11 - "cpu-architecture.tsx"
Cohesion: 0.12
...
Cohesion: 0.07
Nodes (20): CARDS, CICDPipelineVisual, CodeEditorVisual, LayoutDesignerVisual, NodeGraphVisual, SpeedometerGaugeVisual, LOGS, STAGES (+12 more)
...
Cohesion: 0.13
Nodes (9): metadata, CATEGORY_COLORS, metadata, metadata, ProjectsPage(), IDENTITY_KEYWORDS, PageMetaInput, SITE (+1 more)
...
Cohesion: 0.12
Nodes (9): getSupabaseClient(), makeClient(), AllowedUserRow, BlogPost, BlogStatus, Certificate, CompanyRow, Database (+1 more)

### Community 21 - "projects/[slug]/page.tsx"
Cohesion: 0.15
Nodes (22): ASIDE_BY_SLUG, catalogFromStatic(), CatalogProject, DEFAULT_HOOKS, displayTitle(), generateMetadata(), hooksFor(), neighborTitle() (+14 more)

### Community 22 - "hero.tsx"
Cohesion: 0.24
Nodes (7): CvModal, HeroSection(), CV_PAGES, CvModal(), CvModalProps, GlitchText(), GlitchTextProps

### Community 25 - "project-card.tsx"
Cohesion: 0.17
Nodes (12): CardVariant, ProjectCard(), QuickLink(), ProjectLinks(), ProjectLinksProps, ProjectTag(), ProjectTagProps, getCaseStudySlugByProjectId() (+4 more)
...
Cohesion: 0.21
Nodes (6): ProjectsPageProps, ProjectsProps, ProjectGridSkeleton(), Skeleton(), FEATURED_PROJECT_IDS, Project
...
### Community 40 - "json-ld.tsx"
Cohesion: 0.11
Nodes (19): geistMono, geistSans, metadata, spaceGrotesk, viewport, allSchemas, BlogJsonLd(), breadcrumbSchema (+11 more)

### Community 41 - "(public)/page.tsx"
Cohesion: 0.29
Nodes (6): base, metadata, Companies(), FEATURES, Press(), Projects()

### Community 44 - "use-api.ts"
Cohesion: 0.31
Nodes (10): fetchApi(), useApi(), UseApiResult, useAuthUser(), useCertificates(), useCompanies(), useNonPinnedCertificates(), usePinnedCertificates() (+2 more)

### Community 45 - "blog/[slug]/page.tsx"
Cohesion: 0.19
Nodes (11): BlogDetailPage(), BlogDetailPageProps, CATEGORY_LABELS, formatDate(), generateMetadata(), MarkdownRenderer(), MarkdownRendererProps, ShareButtons() (+3 more)
...
### Community 62 - "cn"
Cohesion: 0.33
Nodes (6): AdminShell(), NAV_ITEMS, Button(), buttonVariants, WavyBackground(), cn()
...
### Community 65 - "services/page.tsx"
Cohesion: 0.33
Nodes (4): metadata, Process(), STEPS, Services()

### Community 66 - "companies.tsx"
Cohesion: 0.40
Nodes (3): CompaniesProps, CompanyLogoSkeleton(), Company

## Knowledge Gaps
- **416 isolated node(s):** `metadata`, `CATEGORY_LABELS`, `BlogDetailPageProps`, `metadata`, `CATEGORY_LABELS` (+411 more)
...
- **Why does `cn()` connect `cn` to `navigation.tsx`, `utils.ts`, `cpu-architecture.tsx`, `pcb-background.tsx`, `page-shell.tsx`, `hero.tsx`, `project-card.tsx`, `projects-page.tsx`?**
  _High betweenness centrality (0.031) - this node is a cross-community bridge._
- **Why does `PageShell()` connect `page-shell.tsx` to `services/page.tsx`, `companies.tsx`, `utils.ts`, `blog.ts`, `data/projects.ts`, `(public)/page.tsx`, `blog/[slug]/page.tsx`, `services.tsx`, `cn`, `projects-page.tsx`?**
...
- **Should `admin/blog/route.ts` be split into smaller, more focused modules?**
