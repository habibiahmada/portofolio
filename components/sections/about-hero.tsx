...
export function AboutHero() {
  ...
  const nodeMouseRef = useRef<{ x: number; y: number; active: boolean }>({ x: 0, y: 0, active: false });
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full px-24 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center flex-1">
        ...
        <div className="lg:col-span-9 max-w-4xl flex flex-col items-start gap-8 lg:self-center z-10 relative">
          ...
          <p
            className="text-lg md:text-xl text-muted-foreground/90 leading-relaxed font-medium max-w-2xl mt-4"
          >
            <span className="text-foreground font-semibold">Full-Stack Web Developer</span> experienced in building responsive apps and CMS products. Skilled in crafting end-to-end features using <span style={{ color: "var(--navy-accent-text)" }} className="font-semibold">Next.js, React, Laravel, Node.js,</span> and <span className="text-foreground font-semibold">WordPress</span> to deliver production-ready solutions.
          </p>
