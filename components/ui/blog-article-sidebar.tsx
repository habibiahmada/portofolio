    ...
    <>
      ...
      <div className="lg:hidden">
        <button
          ...
          aria-label="Open share and navigation"
        ...
        <aside
          ...
          role="dialog"
          aria-modal="true"
          aria-label="Share and on this page"
        ...
        {/* Collapsed hint when panel open (edge chevron to close) */}
        {open && (
          <button
            type="button"
            onClick={() => setOpen(false)}
            aria-label="Close share and navigation"
