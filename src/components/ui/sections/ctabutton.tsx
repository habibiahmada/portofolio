  ...
  return (
    <Link
      ...
      className={`group inline-flex items-center justify-center gap-3 px-5 py-2 rounded-full font-semibold text-lg  hover:scale-105 focus:outline-none focus:ring-4 transition-all duration-300 ${isDark
        ? "bg-linear-to-r from-blue-600 to-cyan-600 text-white hover:shadow-xl hover:shadow-blue-500/30 focus:ring-blue-500/50"
        : "bg-linear-to-r from-blue-600 to-cyan-600 text-white hover:shadow-lg hover:shadow-blue-500/30 focus:ring-blue-500/50"
        }`}
    >
