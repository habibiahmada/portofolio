...
export default function ProjectCard({ project }: { project: Project }) {
  ...
  return (
    <div className="group bg-white dark:bg-slate-900 rounded-xl shadow-sm border border-slate-500 dark:border-slate-700 overflow-hidden hover:shadow-2xl hover:shadow-blue-600/10 dark:hover:shadow-blue-400/10 transition-all duration-300 transform hover:-translate-y-2">
      {/* Image */}
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center gap-3">
            <a
              ...
              className="w-10 h-10 rounded-full bg-slate-100 dark:bg-slate-700 text-slate-600 dark:text-slate-400 hover:bg-blue-100 hover:text-blue-600 dark:hover:bg-blue-900/30 dark:hover:text-blue-400 flex items-center justify-center transition-all duration-200"
            >
