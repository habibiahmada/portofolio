...
const SkeletonImage = ({ className = "" }) => (
  <div className={`animate-pulse bg-gray-200 dark:bg-gray-700 rounded aspect-square ${className}`} />
);

const SkeletonButton = ({ className = "" }) => (
  <div className={`animate-pulse bg-gray-200 dark:bg-gray-700 rounded-2xl h-14 w-40 ${className}`} />
);
          ...
          >
            <div className="relative group">
              <div className="relative">
                {isLoading ? (
                  <SkeletonImage className="w-full max-w-sm sm:max-w-md lg:max-w-lg mx-auto border-4 border-gray-200 dark:border-gray-700" />
                ) : (
                  <Image
              ...
              <div className="space-y-8 text-center lg:text-left">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex justify-center lg:justify-start gap-2">
                    <SkeletonText width="w-20" height="h-1" />
                    <SkeletonText width="w-8" height="h-1" />
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  <div className="space-y-3">
                    ...
                    <SkeletonText width="w-5/6" height="h-6" />
                  </div>
