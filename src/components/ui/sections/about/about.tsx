...
export default function About() {
    ...
    return (
        <section 
            id="about" 
            className={`relative overflow-hidden transition-all duration-700 py-24 sm:py-28 lg:py-32
                        ${isDark 
                            ? "bg-slate-950" 
                        ...
                        <div className="relative group">
                            <div className="relative">                                  
                                <Image
                                    ...
                                    width={600}
                                    height={600}
                                    className="relative w-90 max-w-sm sm:max-w-md lg:max-w-lg mx-auto transition-all duration-700 group-hover:scale-[1.02] border-4"
                                    priority
                                    draggable={false}
                                />
                            </div>
                            <div className={`absolute -top-6 -right-6 w-16 h-16 border-4 rotate-45 ${
                    ...
                    >
                        ...
                        <div className="space-y-4">
                            <p className={`text-lg sm:text-xl leading-relaxed ${
                                ...
                                Saya seorang <span className="font-bold">Web Developer</span> dan siswa <span className="font-bold">SMKN 1 Karawang</span> dengan minat yang tinggi dalam membangun solusi digital modern.
                            </p>
                            <p className={`text-base leading-relaxed ${
                                isDark ? "text-slate-400" : "text-slate-600"
                            }`}>
                                Terampil dalam berbagai bahasa pemrograman dan berbagai framework populer serta berpengalaman di proyek frontend dan backend.
                            </p>
                            <p className={`text-base leading-relaxed ${
                                isDark ? "text-slate-400" : "text-slate-600"
                            }`}>
                                Saya selalu termotivasi untuk belajar teknologi baru dan menghadirkan solusi yang berdampak nyata.
                            </p>
                        </div>
