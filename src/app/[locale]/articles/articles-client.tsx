...
import { ArticleData } from '@/services/api/public/articles';
          ...
          {featuredArticle && (
            <section className="px-6 pb-16">
              <div className="container mx-auto">
                ...
                >
                  <div className="relative overflow-hidden rounded-3xl bg-linear-to-br dark:from-slate-900 dark:to-slate-800 from-slate-100 to-slate-300">
